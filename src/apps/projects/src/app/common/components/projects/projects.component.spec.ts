...
describe('ProjectsComponent', () => {
  ...
  it('should filter projects by company name', () => {
    ...
    const filteredCompanyNames = component.filteredCompanies.map(company => company.name);
  ...
  it('should filter projects by project title', () => {
    ...
    const filteredProjectTitles = component.filteredProjects.map(project => project.title);
  ...
  it('should display the correct project titles for a company', () => {
    ...
    const displayedProjects = fixture.debugElement.queryAll(By.css('.card-title'));

    displayedProjects.forEach((debugElement, index) => {
      expect(debugElement.nativeElement.textContent).toContain(cebraceProjects[index].title);
    });
  });
