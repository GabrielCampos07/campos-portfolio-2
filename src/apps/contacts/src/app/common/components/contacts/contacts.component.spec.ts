...
describe('ContactsComponent', () => {
  ...
  it('should display LinkedIn contact info correctly', () => {
    ...
    expect(text.textContent).toContain('Connect and message me for professional networking.');
    expect(button.textContent).toContain('Visit LinkedIn');
    expect(button.getAttribute('href')).toBe('https://www.linkedin.com/in/gabrielcampos07/');
  });
  ...
  it('should display Email contact info correctly', () => {
    ...
    expect(text.textContent).toContain('Send your questions, suggestions, or comments.');
    expect(button.textContent).toContain('Send Email');
    expect(button.getAttribute('href')).toBe('mailto:gabriel.c.depaula@gmail.com');
  });
  ...
  it('should display GitHub contact info correctly', () => {
    ...
    expect(text.textContent).toContain('Explore my projects and code repositories. Follow me please!');
    expect(button.textContent).toContain('Visit GitHub');
    expect(button.getAttribute('href')).toBe('https://github.com/GabrielCampos07');
  });
});
